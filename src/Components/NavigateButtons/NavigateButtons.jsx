...
const NavigateButtons = () => {
  ...
  //---------------------------------/return to here and delete button from dispatch method //!filterProducts//------------------------
  return (
    <div>
      ...
      <div className='flex justify-center item-center py-4 '>
        <img className='h-[600px] w-[700px] rounded-md shadow-lg shadow-gray-600 ' src={clothes} alt='clothes' />
      </div>
    </div>
  )
}
